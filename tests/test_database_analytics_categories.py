...
def test_get_category_sales_prefers_normalized_category_supabase(monkeypatch):
    class _Query:
...
def test_get_category_sales_falls_back_to_group_name_sqlite(monkeypatch):
    ...
    assert out == [{"category": "Soft Beverages", "amount": 3960.0, "qty": 6}]
