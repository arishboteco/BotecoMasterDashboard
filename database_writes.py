...
def upsert_daily_summary_supabase(
    ...
    row_data = {
        ...
        "my_amount": data.get("my_amount", 0),
        ...
        "due_payment_sales": data.get("due_payment_sales", 0),
        "wallet_sales": data.get("wallet_sales", 0),
        "upi_sales": data.get("upi_sales", 0),
        "bank_transfer_sales": data.get("bank_transfer_sales", 0),
        "boh_sales": data.get("boh_sales", 0),
        ...
        "pickup_sales": data.get("pickup_sales", 0),
        "dine_in_sales": data.get("dine_in_sales", 0),
        "menu_qr_sales": data.get("menu_qr_sales", 0),
